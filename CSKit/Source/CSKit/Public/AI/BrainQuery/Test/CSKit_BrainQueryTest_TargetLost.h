...
/**
 * @file CSKit_BrainQueryTest_TargetLost.h
...
#include "CSKit_BrainQueryTest_TargetLost.generated.h"

UCLASS()
class CSKIT_API UCSKit_BrainQueryTest_TargetLost : public UCSKit_BrainQueryTest_Base
{
	GENERATED_BODY()
